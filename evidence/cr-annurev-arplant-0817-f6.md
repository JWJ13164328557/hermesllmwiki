...
# In all cases, however, biological validation is required to ensure the predicted trajectories match 

## Claim
In all cases, however, biological validation is required to ensure the predicted trajectories match biological data.
